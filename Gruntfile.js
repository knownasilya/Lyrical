...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
    'linker/components/jquery/jquery.js',
    'linker/components/handlebars/handlebars.js',
    'linker/components/ember/ember.js',
    'linker/components/ember-data/ember-data.js',
    ...
    'linker/compiled/templates.js',

    'linker/js/app.js',
    'linker/js/controllers/*.js',
    'linker/js/serializers/*.js',
    'linker/js/adapters/*.js',
    'linker/js/models/*.js',
    'linker/js/routes/*.js',
    'linker/js/router.js',
    'linker/js/views/*.js',
    ...
    emberTemplates: {
      options: {
        templateName: function (sourceFile) {
          var templatePath = 'assets/linker/templates/';
          return sourceFile.replace(templatePath, '');
        }
      },
      dev: {
        files: {
          'assets/linker/compiled/templates.js': 'assets/linker/templates/{,*/}*.handlebars'
        }
      }
    },
